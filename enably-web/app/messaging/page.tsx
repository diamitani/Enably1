  ...
  return (
    <div className="min-h-screen bg-[#0B1020]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        <h1 className="text-3xl font-bold text-white md:text-4xl">Messaging</h1>
        <p className="mt-4 max-w-lg mx-auto text-slate-400">Email templates, DM snippets, phone scripts — with dynamic variable chips</p>
        <Link
          href="/dashboard"
