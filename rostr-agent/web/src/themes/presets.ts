...
/**
 * Enably GTM OS — Electric indigo primary with emerald accents.
 * Clean, modern SaaS aesthetic for GTM teams.
 * Primary: #635BFF (electric indigo), Accent: #10B981 (emerald)
 */
export const enablyTheme: DashboardTheme = {
  name: "enably",
  label: "Enably GTM",
  description: "Modern SaaS — electric indigo with emerald success accents",
  palette: {
    background: { hex: "#0B1020", alpha: 1 },
    midground: { hex: "#E5E7EB", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0 },
    warmGlow: "rgba(99, 91, 255, 0.25)",
    noiseOpacity: 0.5,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
  ...
  seriesColors: {
    ...
    outputTokenAccent: "#10B981",
  },
  swatchColors: ["#635BFF", "#10B981", "#0B1020"],
